...
- **놀이 콘텐츠**: 장난감·은신처·휴식 시설 15종을 루나로 구매해 데스크톱에 배치. 돌아다니던 유령이 가끔 다가가 가지고 노는 모습을 보여줌 (스탯에는 영향 없는 순수 장식)
- **진행 상황 자동 저장**: 앱을 껐다 켜도 포획한 유령·루나·봉인구·레벨·배치한 장식이 유지됨
...
GhostWidget/
  ...
  DecorCatalog / DecorArt / DecorWindow / DecorShopWindow  장난감 · 은신처 · 휴식 시설 15종
